...
from src.parser.f572_parser import parse_f572_pdf_text, sync_f572_to_env, is_invoice_already_in_f572
from src.models.f572 import F572Data, DependentModel
...
class TestF572Parser(unittest.TestCase):
    def test_non_destructive_env_sync(self):
        ...
        f572_data = F572Data(
            ...
            fiscal_year=2026,
            dependents=[
                DependentModel(first_name="Mateo", last_name="Perez", cuit="20551234569")
            ]
        )
