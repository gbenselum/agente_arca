...
class TestModels(unittest.TestCase):
    ...
    def test_dependent_model_full_name(self):
        dep = DependentModel(first_name="Mateo", last_name="Perez", cuit="20-55123456-9", birth_date="2018-04-12")
        self.assertEqual(dep.cuit, "20551234569")
        self.assertEqual(dep.full_name, "Mateo Perez")

    def test_f572_data_model(self):
        data = F572Data(taxpayer_cuit="20-12345678-9", taxpayer_name="Juan Perez", fiscal_year=2026)
